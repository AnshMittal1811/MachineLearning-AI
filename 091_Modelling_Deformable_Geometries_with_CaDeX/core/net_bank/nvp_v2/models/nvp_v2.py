...
class NVP_v2_1(nn.Module):
    # * version v2.1 recover the explicit affine. to be safe, we separate a new version
    def __init__(
        self,
        n_layers,
        feature_dims,
...
class NVP_v2_2(nn.Module):
    # * version v2.2 put the explicit affine at the beginning of forward. to be safe, we separate a new version
    def __init__(
        self,
        n_layers,
        feature_dims,
