...
from .common import transform_points, project_to_camera
...
def visualise_projection(
    ...
    '''
    points_transformed = transform_points(points, world_mat)
    points_img = project_to_camera(points_transformed, camera_mat)
