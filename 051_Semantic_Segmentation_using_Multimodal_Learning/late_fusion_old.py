...
merge_rgb_nir = concatenate([conv_model_rgb, conv_model_nir], axis=-1)
...
model.fit_generator(train_generator,steps_per_epoch=100,epochs=125, callbacks=[progbar,checkpoint,board],validation_data = valid_generator, validation_steps = 4, max_q_size=4, pickle_safe = True)
