...
# training
batch_size=1
[ `whoami` = 'root' ] && batch_size=1

lr=0.0001
gpu_ids='0'
[ `whoami` = 'root' ] && gpu_ids='0'

checkpoints_dir='./checkpoints/'
[ `whoami` = 'root' ] && checkpoints_dir='/workspace/data/checkpoints/'

resume_checkpoints_dir='./checkpoints'
[ `whoami` = 'root' ] && resume_checkpoints_dir=$checkpoints_dir
...
test_num=1
print_freq=5
[ `whoami` = 'root' ] && print_freq=20

test_freq=20
[ `whoami` = 'root' ] && test_freq=500
