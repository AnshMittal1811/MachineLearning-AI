...
class TrainerFeatures(Trainer):
    ...
    def forward_pass(self, x, val_step = False):
        ...
        with tf.GradientTape() as tape:
            ...
            if self.features.translate.use == False:
                pp_inv = tf_center(pp_inv)
