...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
        ...
        # self.mask_token_dec = nn.Parameter(torch.zeros(1, 1, embed_dim))
    ...
    def initialize_weights(self):
        ...
        # torch.nn.init.normal_(self.mask_token_dec, std=.02)
    ...
    def unshuffle_encoder_output(self, x, ids_restore):
    ...
    def forward_decoder(self, x, ids_restore, decoder_ix=0):
        # embed tokens
    ...
    def forward(self, imgs, mask_ratio=0.75, decoder_ix=0):
