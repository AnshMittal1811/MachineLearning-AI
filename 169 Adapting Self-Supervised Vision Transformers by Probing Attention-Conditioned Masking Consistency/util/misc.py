...
def load_model(args, model_without_ddp, optimizer, loss_scaler, strict=True, load_optim_from_ckpt=True):
    if args.resume:
        ...
        if load_optim_from_ckpt and 'optimizer' in checkpoint and 'epoch' in checkpoint and not (hasattr(args, 'eval') and args.eval):
