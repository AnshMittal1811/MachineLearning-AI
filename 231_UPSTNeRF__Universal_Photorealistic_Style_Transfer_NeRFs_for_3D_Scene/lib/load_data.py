...
from .load_tankstemple import load_tankstemple_data,load_tankstemple_data_org
...
def load_data(args):
    ...
    elif args.dataset_type == 'tankstempleorg':
        images, poses, render_poses, hwf, Ks, i_split = load_tankstemple_data_org(args.datadir)
        # print('Loaded tankstemple', images.shape, render_poses.shape, hwf, args.datadir)
        i_train, i_val, i_test = i_split
