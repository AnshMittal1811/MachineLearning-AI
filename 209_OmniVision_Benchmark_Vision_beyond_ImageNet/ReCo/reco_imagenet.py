...
from losses import PaCoLoss,ReCoLoss
...
parser.add_argument('--data', metavar='DIR', default='/mnt/lustre/yhzhang/data/imagenet')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    criterion = ReCoLoss(alpha=args.alpha, beta=args.beta, gamma=args.gamma, temperature=args.moco_t, K=args.moco_k).cuda(args.gpu)
