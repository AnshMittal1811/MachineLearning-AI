...
def get_args_parser():
    ...
    # dataset parameters
    parser.add_argument('--img_path', default='./ytvis/train/JPEGImages/')
    parser.add_argument('--ann_path', default='./ytvis/annotations/ytvis_hq-test.json')
...
def main(args):
    ...
    ytvos = 'ytvos'
    ytvos_eval(result_file, ['boundary'], 'ytvis/annotations/ytvis_hq-test.json', max_dets=(100, 300, 1000), get_boundary=True)
    ytvos_eval(result_file, ['segm'], 'ytvis/annotations/ytvis_hq-test.json', max_dets=(100, 300, 1000), get_boundary=False)
