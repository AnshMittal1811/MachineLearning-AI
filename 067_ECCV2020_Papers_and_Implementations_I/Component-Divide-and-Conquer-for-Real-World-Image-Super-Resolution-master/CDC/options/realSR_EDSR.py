...
def parse_config(local_test=True):
    ...
    # Data Preparation
    parser.add_argument('--dataroot', type=str, default='/home/xiezw/Dataset/RealSR_ICCV19/train/x3')
    ...
    ## Train Settings
    parser.add_argument('--exp_name', type=str, default='EDSR-X3-RealSR', help='')
    ...
    # parser.add_argument('--decay_step', type=list, default=[2e4, 2e5, 4e5, 8e5], help='')
    ...
    parser.add_argument('--model', type=str, default='EDSR', help='[RRDB_net | srresnet | EDSR | RCAN]')
