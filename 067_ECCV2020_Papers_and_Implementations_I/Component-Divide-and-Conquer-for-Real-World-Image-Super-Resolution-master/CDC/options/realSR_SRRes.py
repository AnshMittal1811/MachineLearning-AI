...
def parse_config(local_test=True):
    ...
    # Data Preparation
    parser.add_argument('--dataroot', type=str, default='/home/weipx/RealSR/Dataset/RealSR_ICCV19/train/x4')
    parser.add_argument('--test_dataroot', type=str, default='/home/weipx/RealSR/Dataset/RealSR_ICCV19/valid/x4')
    ...
    ## Train Settings
    parser.add_argument('--exp_name', type=str, default='SRRes-X4-RealSR', help='')
    parser.add_argument('--generatorLR', type=float, default=2e-4, help='learning rate for SR generator')
    parser.add_argument('--decay_step', type=list, default=[6e5], help='')
    ...
    parser.add_argument('--model', type=str, default='srresnet', help='[RRDB_net | srresnet | EDSR | RCAN]')
    ...
    parser.add_argument('--loss', type=str, default='l1', help="content loss ['l1', 'l2', 'c', 'gw']")
    ...
    parser.add_argument('--entropy_lambda', type=float, default=0.1, help='entropy loss lambda')
