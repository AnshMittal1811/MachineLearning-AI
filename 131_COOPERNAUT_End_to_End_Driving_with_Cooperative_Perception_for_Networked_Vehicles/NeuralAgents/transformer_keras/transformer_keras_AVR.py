...
class Transformer_model:
    def __init__(self, input_dim, meta_size=2, n_action=3, batch_size=64, epoch=50,
        ...
        self._solver = 'adam'
        self.learning_rate = 0.0001 # was 0.001
        self._epoch = epoch
    ...
    def compile(self, input_dim, meta_size, optimizer='adam', active_layers=999):
        ...
        # The mast input
        mask_input = Input(shape=(1, self.actor_num))
        ...
        ego_meta_input = Input(shape=(1, meta_size), name='meta')
        ...
        self.model = Model([peer_meta_input, ego_meta_input], final_output)
        self.model.summary()
