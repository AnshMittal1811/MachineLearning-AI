...
# THANKS https://github.com/pytorch/pytorch/issues/74437 !!!!!
import warnings
import contextlib
import torch
...
def _conv2d_gradfix(transpose, weight_shape, stride, padding, output_padding, dilation, groups):
    ...
    class Conv2dGradWeight(torch.autograd.Function):
        ...
        def forward(ctx, grad_output, input, bias):
            ...
            grad_weight = \
                torch.ops.aten.convolution_backward(grad_output, input, empty_weight, bias_sizes=bias_shape,
                                                    stride=stride,
                                                    padding=padding, dilation=dilation, transposed=transpose,
