...
def fetch_x_y(data, limit):
    ...
    x = np.load(train_directory + "/0d341dc58dc8db30eba8db965a5ae8b8_0_24.npy") 
    y = np.load(train_directory + "/0d341dc58dc8db30eba8db965a5ae8b8_0_24.npy")   
...
def trainer(learning_rate=1e-5, batch_size=1, num_epoch=75, n_z=1000):
...
# Train the model
model = trainer(learning_rate=1e-4, batch_size=1, num_epoch=100, n_z=512)
