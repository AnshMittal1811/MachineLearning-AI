...
class ConvNet(object):
    ...
    def paramsFun(self): 
        ...
        params_w_d = { 
                    ...
                    'wOut' : tf.Variable(tf.truncated_normal( [ 5544 , 1 ], stddev = 0.01 ))
                    } 
    ...
    def discriminator(self):  
        ...
        hG4  = tf.reshape( hG4, [batch_size, -1 ] )      
        logits  = tf.matmul( hG4, self.params_w_d_['wOut'] ) + self.params_b_d_['bOut'] 
