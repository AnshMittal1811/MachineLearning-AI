...
void search_leaf_float(float *  pa, uint32_t *  pidx, int8_t no_dims, uint32_t start_idx, uint32_t n, float *  point_coord,
                 uint32_t k, uint32_t *  closest_idx, float *  closest_dist);
void search_leaf_float_mask(float *  pa, uint32_t *  pidx, int8_t no_dims, uint32_t start_idx, uint32_t n, float *  point_coord,
                 uint32_t k, uint8_t *  mask, uint32_t *  closest_idx, float *  closest_dist);
...
void search_leaf_double(double *  pa, uint32_t *  pidx, int8_t no_dims, uint32_t start_idx, uint32_t n, double *  point_coord,
                 uint32_t k, uint32_t *  closest_idx, double *  closest_dist);
void search_leaf_double_mask(double *  pa, uint32_t *  pidx, int8_t no_dims, uint32_t start_idx, uint32_t n, double *  point_coord,
                 uint32_t k, uint8_t *  mask, uint32_t *  closest_idx, double *  closest_dist);
